...
function i(e2, o9) {
  ...
  return l(() => t3(r2.current), [r2, t3, ...o9]), u5;
}

// node_modules/@headlessui/react/dist/hooks/use-controllable.js
var import_react2 = __toESM(require_react(), 1);
function T3(l5, r2, c4) {
  let [i2, s6] = (0, import_react2.useState)(c4), e2 = l5 !== void 0, t3 = (0, import_react2.useRef)(e2), u5 = (0, import_react2.useRef)(false), d2 = (0, import_react2.useRef)(false);
  return e2 && !t3.current && !u5.current ? (u5.current = true, t3.current = e2, console.error("A component is changing from uncontrolled to controlled. This may be caused by the value changing from undefined to a defined value, which should not happen.")) : !e2 && t3.current && !d2.current && (d2.current = true, t3.current = e2, console.error("A component is changing from controlled to uncontrolled. This may be caused by the value changing from a defined value to undefined, which should not happen.")), [e2 ? l5 : i2, o((n2) => (e2 || s6(n2), r2 == null ? void 0 : r2(n2)))];
}
...
function o6(e2) {
  ...
  for (let f7 of t3.querySelectorAll('[hidden],[aria-hidden],[role="img"]'))
    f7.remove(), u5 = true;
  let l5 = u5 ? (i2 = t3.innerText) != null ? i2 : "" : n2;
...
// node_modules/@headlessui/react/dist/hooks/use-text-value.js
function s5(c4) {
  let t3 = (0, import_react3.useRef)(""), r2 = (0, import_react3.useRef)("");
  return o(() => {
    let e2 = c4.current;
    if (!e2)
      return "";
...
function o8(i2, s6, t3) {
  if (Array.isArray(t3))
    for (let [r2, n2] of t3.entries())
      o8(i2, f5(s6, r2.toString()), n2);
  else
    t3 instanceof Date ? i2.push([s6, t3.toISOString()]) : typeof t3 == "boolean" ? i2.push([s6, t3 ? "1" : "0"]) : typeof t3 == "string" ? i2.push([s6, t3]) : typeof t3 == "number" ? i2.push([s6, `${t3}`]) : t3 == null ? i2.push([s6, ""]) : e(t3, s6, i2);
}
...
var je = { [1](e2) {
  ...
  if (e2.dataRef.current.disabled || e2.listboxState === 1)
    return e2;
  let r2 = e2.searchQuery !== "" ? 0 : 1, l5 = e2.searchQuery + a2.value.toLowerCase(), p2 = (e2.activeOptionIndex !== null ? e2.options.slice(e2.activeOptionIndex + r2).concat(e2.options.slice(0, e2.activeOptionIndex + r2)) : e2.options).find((i2) => {
    var b2;
    return !i2.dataRef.current.disabled && ((b2 = i2.dataRef.current.textValue) == null ? void 0 : b2.startsWith(l5));
...
function Qe(e2, a2) {
  let { value: n2, defaultValue: r2, form: l5, name: t3, onChange: p2, by: u5 = (s6, c4) => s6 === c4, disabled: i2 = false, horizontal: b2 = false, multiple: R = false, ...m2 } = e2;
  const P = b2 ? "horizontal" : "vertical";
  let S2 = y2(a2), [g3 = R ? [] : void 0, x2] = T3(n2, p2, r2), [T4, o9] = (0, import_react5.useReducer)(Ve, { dataRef: (0, import_react5.createRef)(), listboxState: 1, options: [], searchQuery: "", labelId: null, activeOptionIndex: null, activationTrigger: 1 }), L = (0, import_react5.useRef)({ static: false, hold: false }), U3 = (0, import_react5.useRef)(null), B = (0, import_react5.useRef)(null), W = (0, import_react5.useRef)(null), I4 = o(typeof u5 == "string" ? (s6, c4) => {
    let O2 = u5;
    return (s6 == null ? void 0 : s6[O2]) === (c4 == null ? void 0 : c4[O2]);
  } : u5), A = (0, import_react5.useCallback)((s6) => u(d2.mode, { [1]: () => g3.some((c4) => I4(c4, s6)), [0]: () => I4(g3, s6) }), [g3]), d2 = (0, import_react5.useMemo)(() => ({ ...T4, value: g3, disabled: i2, mode: R ? 1 : 0, orientation: P, compare: I4, isSelected: A, optionsPropsRef: L, labelRef: U3, buttonRef: B, optionsRef: W }), [g3, i2, R, T4]);
  l(() => {
    T4.dataRef.current = d2;
  }, [d2]), y([d2.buttonRef, d2.optionsRef], (s6, c4) => {
    var O2;
    o9({ type: 1 }), h(c4, T.Loose) || (s6.preventDefault(), (O2 = d2.buttonRef.current) == null || O2.focus());
  }, d2.listboxState === 0);
  let H = (0, import_react5.useMemo)(() => ({ open: d2.listboxState === 0, disabled: i2, value: g3 }), [d2, i2, g3]), ie = o((s6) => {
    ...
    if (d2.activeOptionIndex !== null) {
      ...
      X2(s6.current.value), o9({ type: 2, focus: c.Specific, id: c4 });
    }
  }), ae2 = o(() => o9({ type: 0 })), le2 = o(() => o9({ type: 1 })), se2 = o((s6, c4, O2) => s6 === c.Specific ? o9({ type: 2, focus: c.Specific, id: c4, trigger: O2 }) : o9({ type: 2, focus: s6, trigger: O2 })), pe = o((s6, c4) => (o9({ type: 5, id: s6, dataRef: c4 }), () => o9({ type: 6, id: s6 }))), ue2 = o((s6) => (o9({ type: 7, id: s6 }), () => o9({ type: 7, id: null }))), X2 = o((s6) => u(d2.mode, { [0]() {
  ...
  } })), de = o((s6) => o9({ type: 3, value: s6 })), ce = o(() => o9({ type: 4 })), fe = (0, import_react5.useMemo)(() => ({ onChange: X2, registerOption: pe, registerLabel: ue2, goToOption: se2, closeListbox: le2, openListbox: ae2, selectActiveOption: re, selectOption: ie, search: de, clearSearch: ce }), []), Te = { ref: S2 }, G = (0, import_react5.useRef)(null), be = p();
  return (0, import_react5.useEffect)(() => {
    G.current && r2 !== void 0 && be.addEventListener(G.current, "reset", () => {
      x2 == null || x2(r2);
    });
  }, [G, x2]), import_react5.default.createElement(J.Provider, { value: fe }, import_react5.default.createElement(q.Provider, { value: d2 }, import_react5.default.createElement(s3, { value: u(d2.listboxState, { [0]: d.Open, [1]: d.Closed }) }, t3 != null && g3 != null && e({ [t3]: g3 }).map(([s6, c4], O2) => import_react5.default.createElement(f, { features: s2.Hidden, ref: O2 === 0 ? (C2) => {
    var Y;
...
function Xe(e2, a2) {
  var x2;
  let n2 = I(), { id: r2 = `headlessui-listbox-button-${n2}`, ...l5 } = e2, t3 = w("Listbox.Button"), p2 = k("Listbox.Button"), u5 = y2(t3.buttonRef, a2), i2 = p(), b2 = o((T4) => {
    switch (T4.key) {
      case o4.Space:
      case o4.Enter:
      case o4.ArrowDown:
    ...
    t3.listboxState === 0 ? (p2.closeListbox(), i2.nextFrame(() => {
      var o9;
      return (o9 = t3.buttonRef.current) == null ? void 0 : o9.focus({ preventScroll: true });
    })) : (T4.preventDefault(), p2.openListbox());
  }), P = i(() => {
    if (t3.labelId)
      return [t3.labelId, r2].join(" ");
  }, [t3.labelId, r2]), S2 = (0, import_react5.useMemo)(() => ({ open: t3.listboxState === 0, disabled: t3.disabled, value: t3.value }), [t3]), g3 = { ref: u5, id: r2, type: T2(e2, t3.buttonRef), "aria-haspopup": "listbox", "aria-controls": (x2 = t3.optionsRef.current) == null ? void 0 : x2.id, "aria-expanded": t3.listboxState === 0, "aria-labelledby": P, disabled: t3.disabled, onKeyDown: b2, onKeyUp: R, onClick: m2 };
...
function ze(e2, a2) {
  ...
  }), b2 = (0, import_react5.useMemo)(() => ({ open: t3.listboxState === 0, disabled: t3.disabled }), [t3]);
  return C({ ourProps: { ref: u5, id: r2, onClick: i2 }, theirProps: l5, slot: b2, defaultTag: $e, name: "Listbox.Label" });
}
var Je = "ul";
var qe = O.RenderStrategy | O.Static;
function Ye(e2, a2) {
  var T4;
  let n2 = I(), { id: r2 = `headlessui-listbox-options-${n2}`, ...l5 } = e2, t3 = w("Listbox.Options"), p2 = k("Listbox.Options"), u5 = y2(t3.optionsRef, a2), i2 = p(), b2 = p(), R = u2(), m2 = (() => R !== null ? (R & d.Open) === d.Open : t3.listboxState === 0)();
  (0, import_react5.useEffect)(() => {
    var L;
    let o9 = t3.optionsRef.current;
    o9 && t3.listboxState === 0 && o9 !== ((L = o3(o9)) == null ? void 0 : L.activeElement) && o9.focus({ preventScroll: true });
  }, [t3.listboxState, t3.optionsRef]);
  let P = o((o9) => {
    switch (b2.dispose(), o9.key) {
      case o4.Space:
        if (t3.searchQuery !== "")
          return o9.preventDefault(), o9.stopPropagation(), p2.search(o9.key);
      case o4.Enter:
        if (o9.preventDefault(), o9.stopPropagation(), t3.activeOptionIndex !== null) {
      ...
      case o4.Tab:
        ...
        break;
      default:
        o9.key.length === 1 && (p2.search(o9.key), b2.setTimeout(() => p2.clearSearch(), 350));
        break;
    }
  }), S2 = i(() => {
    var o9;
    return (o9 = t3.buttonRef.current) == null ? void 0 : o9.id;
  }, [t3.buttonRef.current]), g3 = (0, import_react5.useMemo)(() => ({ open: t3.listboxState === 0 }), [t3]), x2 = { "aria-activedescendant": t3.activeOptionIndex === null || (T4 = t3.options[t3.activeOptionIndex]) == null ? void 0 : T4.id, "aria-multiselectable": t3.mode === 1 ? true : void 0, "aria-labelledby": S2, "aria-orientation": t3.orientation, id: r2, onKeyDown: P, role: "listbox", tabIndex: 0, ref: u5 };
  return C({ ourProps: x2, theirProps: l5, slot: g3, defaultTag: Je, features: qe, visible: m2, name: "Listbox.Options" });
}
var Ze = "li";
function et(e2, a2) {
  let n2 = I(), { id: r2 = `headlessui-listbox-option-${n2}`, disabled: l5 = false, value: t3, ...p2 } = e2, u5 = w("Listbox.Option"), i2 = k("Listbox.Option"), b2 = u5.activeOptionIndex !== null ? u5.options[u5.activeOptionIndex].id === r2 : false, R = u5.isSelected(t3), m2 = (0, import_react5.useRef)(null), P = s5(m2), S2 = s({ disabled: l5, value: t3, domRef: m2, get textValue() {
    return P();
  } }), g3 = y2(a2, m2);
  l(() => {
  ...
  }, [m2, b2, u5.listboxState, u5.activationTrigger, u5.activeOptionIndex]), l(() => i2.registerOption(r2, S2), [S2, r2]);
  let x2 = o((A) => {
    if (l5)
      return A.preventDefault();
    i2.onChange(t3), u5.mode === 0 && (i2.closeListbox(), o2().nextFrame(() => {
      var d2;
  ...
  }), o9 = u3(), L = o((A) => o9.update(A)), U3 = o((A) => {
    o9.wasMoved(A) && (l5 || b2 || i2.goToOption(c.Specific, r2, 0));
  }), B = o((A) => {
    o9.wasMoved(A) && (l5 || b2 && i2.goToOption(c.Nothing));
  }), W = (0, import_react5.useMemo)(() => ({ active: b2, selected: R, disabled: l5 }), [b2, R, l5]);
...
function c2(a2 = 0) {
  let [l5, r2] = (0, import_react6.useState)(a2), t3 = f2(), o9 = (0, import_react6.useCallback)((e2) => {
    t3.current && r2((u5) => u5 | e2);
  }, [l5, t3]), m2 = (0, import_react6.useCallback)((e2) => Boolean(l5 & e2), [l5]), s6 = (0, import_react6.useCallback)((e2) => {
    t3.current && r2((u5) => u5 & ~e2);
  }, [r2, t3]), g3 = (0, import_react6.useCallback)((e2) => {
    t3.current && r2((u5) => u5 ^ e2);
  }, [r2]);
  return { flags: l5, addFlag: o9, hasFlag: m2, removeFlag: s6, toggleFlag: g3 };
}
...
function b(t3, e2) {
  ...
  let { transitionDuration: m2, transitionDelay: a2 } = getComputedStyle(t3), [u5, p2] = [m2, a2].map((l5) => {
    let [r2 = 0] = l5.split(",").filter(Boolean).map((i2) => i2.includes("ms") ? parseFloat(i2) : parseFloat(i2) * 1e3).sort((i2, T4) => T4 - i2);
    return r2;
  }), o9 = u5 + p2;
  if (o9 !== 0) {
    n2.group((r2) => {
...
function M(t3, e2, n2, m2) {
  ...
  let o9 = u(a2, { enter: () => e2.enter, leave: () => e2.leave }), l5 = u(a2, { enter: () => e2.enterTo, leave: () => e2.leaveTo }), r2 = u(a2, { enter: () => e2.enterFrom, leave: () => e2.leaveFrom });
  return v2(t3, ...e2.base, ...e2.enter, ...e2.enterTo, ...e2.enterFrom, ...e2.leave, ...e2.leaveFrom, ...e2.leaveTo, ...e2.entered), g2(t3, ...e2.base, ...o9, ...r2), u5.nextFrame(() => {
    v2(t3, ...e2.base, ...o9, ...r2), g2(t3, ...e2.base, ...o9, ...l5), b(t3, () => (v2(t3, ...e2.base, ...o9), g2(t3, ...e2.base, ...e2.entered), p2()));
  }), u5.dispose;
}
...
function D({ immediate: t3, container: s6, direction: n2, classes: u5, onStart: a2, onStop: c4 }) {
  ...
  l(() => {
    ...
    d2.add(r2.dispose);
    let i2 = s6.current;
    if (i2 && e2.current !== "idle" && l5.current)
      return r2.dispose(), a2.current(e2.current), r2.add(M(i2, u5.current, e2.current === "enter", () => {
...
function ye2() {
  let t3 = (0, import_react7.useContext)(I3);
  if (t3 === null)
    throw new Error("A <Transition.Child /> is used but it is missing a parent <Transition /> or <Transition.Root />.");
  return t3;
}
function xe2() {
  let t3 = (0, import_react7.useContext)(M2);
  if (t3 === null)
    throw new Error("A <Transition.Child /> is used but it is missing a parent <Transition /> or <Transition.Root />.");
  return t3;
}
var M2 = (0, import_react7.createContext)(null);
...
function se(t3, n2) {
  let r2 = s(t3), s6 = (0, import_react7.useRef)([]), R = f2(), D2 = p(), p2 = o((i2, e2 = v.Hidden) => {
    let a2 = s6.current.findIndex(({ el: o9 }) => o9 === i2);
    a2 !== -1 && (u(e2, { [v.Unmount]() {
      ...
      var o9;
      !U2(s6) && R.current && ((o9 = r2.current) == null || o9.call(r2));
    }));
  }), x2 = o((i2) => {
    let e2 = s6.current.find(({ el: a2 }) => a2 === i2);
    return e2 ? e2.state !== "visible" && (e2.state = "visible") : s6.current.push({ el: i2, state: "visible" }), () => p2(i2, v.Unmount);
  }), h3 = (0, import_react7.useRef)([]), v3 = (0, import_react7.useRef)(Promise.resolve()), u5 = (0, import_react7.useRef)({ enter: [], leave: [], idle: [] }), g3 = o((i2, e2, a2) => {
    h3.current.splice(0), n2 && (n2.chains.current[e2] = n2.chains.current[e2].filter(([o9]) => o9 !== i2)), n2 == null || n2.chains.current[e2].push([i2, new Promise((o9) => {
      h3.current.push(o9);
    })]), n2 == null || n2.chains.current[e2].push([i2, new Promise((o9) => {
      Promise.all(u5.current[e2].map(([f7, N2]) => N2)).then(() => o9());
    })]), e2 === "enter" ? v3.current = v3.current.then(() => n2 == null ? void 0 : n2.wait.current).then(() => a2(e2)) : a2(e2);
  }), d2 = o((i2, e2, a2) => {
    Promise.all(u5.current[e2].splice(0).map(([o9, f7]) => f7)).then(() => {
      var o9;
      (o9 = h3.current.shift()) == null || o9();
    }).then(() => a2(e2));
  });
  return (0, import_react7.useMemo)(() => ({ children: s6, register: x2, unregister: p2, onStart: g3, onStop: d2, wait: v3, chains: u5 }), [x2, p2, s6, g3, d2, u5, v3]);
}
function Ne2() {
}
...
function Re(t3) {
  let n2 = (0, import_react7.useRef)(ae(t3));
...
function He2(t3, n2) {
  var Q, Y;
  let { beforeEnter: r2, afterEnter: s6, beforeLeave: R, afterLeave: D2, enter: p2, enterFrom: x2, enterTo: h3, entered: v3, leave: u5, leaveFrom: g3, leaveTo: d2, ...i2 } = t3, e2 = (0, import_react7.useRef)(null), a2 = y2(e2, n2), o9 = (Q = i2.unmount) == null || Q ? v.Unmount : v.Hidden, { show: f7, appear: N2, initial: T4 } = ye2(), [l5, j] = (0, import_react7.useState)(f7 ? "visible" : "hidden"), z2 = xe2(), { register: L, unregister: O2 } = z2;
  (0, import_react7.useEffect)(() => L(e2), [L, e2]), (0, import_react7.useEffect)(() => {
    if (o9 === v.Hidden && e2.current) {
      if (f7 && l5 !== "visible") {
        j("visible");
        return;
      }
  ...
  let k2 = s({ base: S(i2.className), enter: S(p2), enterFrom: S(x2), enterTo: S(h3), entered: S(v3), leave: S(u5), leaveFrom: S(g3), leaveTo: S(d2) }), V = Re({ beforeEnter: r2, afterEnter: s6, beforeLeave: R, afterLeave: D2 }), G = l2();
  ...
  let Te = T4 && !N2, K = N2 && f7 && T4, de = (() => !G || Te ? "idle" : f7 ? "enter" : "leave")(), H = c2(0), fe = o((C2) => u(C2, { enter: () => {
    ...
    j("hidden"), O2(e2);
  }, z2), B = (0, import_react7.useRef)(false);
  ...
  let P = i2, ce = { ref: a2 };
  return K ? P = { ...P, className: t(i2.className, ...k2.current.enter, ...k2.current.enterFrom) } : B.current && (P.className = t(i2.className, (Y = e2.current) == null ? void 0 : Y.className), P.className === "" && delete P.className), import_react7.default.createElement(M2.Provider, { value: w2 }, import_react7.default.createElement(s3, { value: u(l5, { ["visible"]: d.Open, ["hidden"]: d.Closed }) | H.flags }, C({ ourProps: ce, theirProps: P, defaultTag: De, features: le, visible: l5 === "visible", name: "Transition.Child" })));
}
function Fe(t3, n2) {
  let { show: r2, appear: s6 = false, unmount: R = true, ...D2 } = t3, p2 = (0, import_react7.useRef)(null), x2 = y2(p2, n2);
  l2();
  let h3 = u2();
  if (r2 === void 0 && h3 !== null && (r2 = (h3 & d.Open) === d.Open), ![true, false].includes(r2))
    throw new Error("A <Transition /> is used but it is missing a `show={true | false}` prop.");
  let [v3, u5] = (0, import_react7.useState)(r2 ? "visible" : "hidden"), g3 = se(() => {
    u5("hidden");
  }), [d2, i2] = (0, import_react7.useState)(true), e2 = (0, import_react7.useRef)([r2]);
  l(() => {
    d2 !== false && e2.current[e2.current.length - 1] !== r2 && (e2.current.push(r2), i2(false));
  }, [e2, r2]);
  let a2 = (0, import_react7.useMemo)(() => ({ show: r2, appear: s6, initial: d2 }), [r2, s6, d2]);
  (0, import_react7.useEffect)(() => {
    if (r2)
      u5("visible");
    else if (!U2(g3))
  ...
  let o9 = { unmount: R }, f7 = o(() => {
    var T4;
    d2 && i2(false), (T4 = t3.beforeEnter) == null || T4.call(t3);
  }), N2 = o(() => {
    var T4;
    d2 && i2(false), (T4 = t3.beforeLeave) == null || T4.call(t3);
  });
  return import_react7.default.createElement(M2.Provider, { value: g3 }, import_react7.default.createElement(I3.Provider, { value: a2 }, C({ ourProps: { ...o9, as: import_react7.Fragment, children: import_react7.default.createElement(ue, { ref: x2, ...o9, ...D2, beforeEnter: f7, beforeLeave: N2 }) }, theirProps: {}, defaultTag: import_react7.Fragment, features: le, visible: v3 === "visible", name: "Transition" })));
}
function _e(t3, n2) {
  let r2 = (0, import_react7.useContext)(I3) !== null, s6 = u2() !== null;
  return import_react7.default.createElement(import_react7.default.Fragment, null, !r2 && s6 ? import_react7.default.createElement(q2, { ref: n2, ...t3 }) : import_react7.default.createElement(ue, { ref: n2, ...t3 }));
}
var q2 = U(Fe);
var ue = U(He2);
var Le2 = U(_e);
...
var CSSTransition = /* @__PURE__ */ function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return /* @__PURE__ */ import_react10.default.createElement(Transition_default, _extends({}, props, {
...
function getChildMapping(children, mapFn) {
  ...
  if (children)
    import_react11.Children.map(children, function(c4) {
      return c4;
...
var __assign = function() {
  __assign = Object.assign || function(t3) {
    for (var s6, i2 = 1, n2 = arguments.length; i2 < n2; i2++) {
      s6 = arguments[i2];
      for (var p2 in s6)
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1707804700276.3142";
}
function CardLayout({
  mode,
  tab,
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(import_jsx_dev_runtime.Fragment, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "h-full", children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("ul", { role: "list", className: "mx-4 my-4 grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 ", children: kpiData.map((kpi) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("li", { className: "col-span-1 flex flex-col divide-y divide-gray-200 rounded-lg bg-white shadow-xl shadow-slate-900/10 ", children: [
...
//# sourceMappingURL=/build/_shared/chunk-GNHNWI7H.js.map
