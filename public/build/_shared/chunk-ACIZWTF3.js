...
var $cc7e05a45900e73f$export$c973a4b3cb86a03d = /* @__PURE__ */ (0, import_react5.forwardRef)((props, forwardedRef) => {
  ...
  if (!context.open) {
    const frag = fragment;
    return frag ? /* @__PURE__ */ (0, import_react_dom.createPortal)(/* @__PURE__ */ (0, import_react5.createElement)($cc7e05a45900e73f$var$SelectContentProvider, {
      scope: props.__scopeSelect
...
var $cc7e05a45900e73f$export$ee25a334c55de1f4 = /* @__PURE__ */ (0, import_react5.forwardRef)((props, forwardedRef) => {
  const { __scopeSelect, ...groupProps } = props;
  const groupId = $1746a345f3d73bb7$export$f680877a34711e37();
  return /* @__PURE__ */ (0, import_react5.createElement)($cc7e05a45900e73f$var$SelectGroupContextProvider, {
    scope: __scopeSelect,
    id: groupId
  }, /* @__PURE__ */ (0, import_react5.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.div, _extends({
    role: "group",
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1707396754179.138";
}
...
var SelectItem = React.forwardRef(_c11 = ({
  ...
  children,
  ...props
}, ref) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)($cc7e05a45900e73f$export$6d08773d2e66f8f2, { ref, className: cn("relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-2 pr-8 text-sm outline-none focus:bg-neutral-100 focus:text-neutral-900 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 dark:focus:bg-neutral-800 dark:focus:text-neutral-50", className), ...props, children: [
...
var SelectSeparator = React.forwardRef(_c13 = ({
  className,
  ...props
}, ref) => /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)($cc7e05a45900e73f$export$1ff3c3f08ae963c0, { ref, className: cn("-mx-1 my-1 h-px bg-neutral-100 dark:bg-neutral-800", className), ...props }, void 0, false, {
  fileName: "app/components/ui/select.tsx",
  lineNumber: 95,
  columnNumber: 12
}, this));
...
//# sourceMappingURL=/build/_shared/chunk-ACIZWTF3.js.map
